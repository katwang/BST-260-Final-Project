...
agg_data_cor1 <- agg_data[, c("EHR_use", "num_phys_log","female_prop","n_specialty","staffed_beds_log","total_discharge","patient_days", "gross_patient_rev_log","yrs_since_grad")]
...
agg_data_cor2 <- tidy(round(cor(agg_data_cor1, use="complete.obs"), 2))
